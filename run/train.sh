...
compression_max_len=${COMPRESSION_MAX_LEN:-64}
compression_lambda=${COMPRESSION_LAMBDA:-0.0}
...
run_name_suffix="sub${training_substeps}_seg${segments_per_substep}_c${compression_max_len}_lr${lr}_bsz${total}"
